...
//   });
//
//   it("should pass the variable from the parent element so a child can interpolate the value", async (done: DoneFn) => {
...
//   });
//
//   it("should pass the variable from the parent element so it can be used by other directives", async (done: DoneFn) => {
//     fixture.whenStable().then(() => {
